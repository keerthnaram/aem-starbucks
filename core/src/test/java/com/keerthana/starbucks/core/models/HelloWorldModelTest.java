 ...
 */
package com.keerthana.starbucks.core.models;
...
import com.keerthana.starbucks.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "Starbucks/components/helloworld");
